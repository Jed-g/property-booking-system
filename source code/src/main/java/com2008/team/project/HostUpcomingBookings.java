...
public class HostUpcomingBookings extends javax.swing.JPanel {
    ...
    */
    ...
    private void initComponents() {
        ...
        viewChange = new javax.swing.JButton();
        ...
        navigation.setVerifyInputWhenFocusTarget(false);
        ...
        viewChange.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        viewChange.setText("Switch to Guest view");
        viewChange.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                viewChangeActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(viewChange, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(viewChange, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void fillUpcomingBoxes(int indexFirstUpcomingOnPage) {
        ...
        if (indexFirstUpcomingOnPage + 4 > upcomingList.length){
            maxAmountBoxes = upcomingList.length - indexFirstUpcomingOnPage;
        }
        if (maxAmountBoxes >= 1){
            propName1.setText(upcomingList[indexFirstUpcomingOnPage].getPropertyName());
            propLocation1.setText(upcomingList[indexFirstUpcomingOnPage].getLocation());
            dateRange1.setText(upcomingList[indexFirstUpcomingOnPage].getDateRange());
            guestName1.setText(upcomingList[indexFirstUpcomingOnPage].getGuestName());
        }
        if (maxAmountBoxes >= 2){
            propName2.setText(upcomingList[indexFirstUpcomingOnPage +1].getPropertyName());
            propLocation2.setText(upcomingList[indexFirstUpcomingOnPage +1].getLocation());
            dateRange2.setText(upcomingList[indexFirstUpcomingOnPage +1].getDateRange());
            guestName2.setText(upcomingList[indexFirstUpcomingOnPage +1].getGuestName());
        }
        if (maxAmountBoxes >= 3){
            propName3.setText(upcomingList[indexFirstUpcomingOnPage +2].getPropertyName());
            propLocation3.setText(upcomingList[indexFirstUpcomingOnPage +2].getLocation());
            dateRange3.setText(upcomingList[indexFirstUpcomingOnPage +2].getDateRange());
            guestName3.setText(upcomingList[indexFirstUpcomingOnPage +2].getGuestName());
        }
        if (maxAmountBoxes == 4){
            propName4.setText(upcomingList[indexFirstUpcomingOnPage +3].getPropertyName());
            propLocation4.setText(upcomingList[indexFirstUpcomingOnPage +3].getLocation());
            dateRange4.setText(upcomingList[indexFirstUpcomingOnPage +3].getDateRange());
            guestName4.setText(upcomingList[indexFirstUpcomingOnPage +3].getGuestName());
        }
    ...
    private void viewChangeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewChangeActionPerformed
        jFrameInstance.changePanelToSpecific(new Guestmain(jFrameInstance, jFrameInstance.getEmail()));
    }//GEN-LAST:event_viewChangeActionPerformed
    ...
    private javax.swing.JButton viewChange;
