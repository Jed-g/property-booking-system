...
public class PropertyList {
    ...
    private static String getRating(int propertyId) {
        ...
        try (Connection con = DriverManager.getConnection("jdbc:mysql://stusql.dcs.shef.ac.uk/team024", "team024", "c0857903")) {
            ...
            for (int i = 0; i <= numberOfProperties; i++){
                if (res.next()){  
                    ...
                    rating = getRating(res.getInt("propertyId"));
    ...
    static PropertyList[] searchByLocation1( String location) {
        DriverManager.setLoginTimeout(3);
        
        PropertyList[] searchPropList1 = null;
        ...
        try (Connection con = DriverManager.getConnection("jdbc:mysql://stusql.dcs.shef.ac.uk/team024", "team024", "c0857903")) {
            ...
            searchPropList1 = new PropertyList[numberOfProperties];
            String rating;            
            ...
            for (int i = 0; i < numberOfProperties; i++){
                if (res.next()){  
                    ...
                    searchPropList1[i] = new PropertyList(res.getString("propertyName"), res.getString("location"),
                            rating, res.getString("description"), res.getInt("propertyId"));
                }
            }
