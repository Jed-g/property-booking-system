 ...
 * @author Matyas Szert
 */
public class viewProperty1 extends javax.swing.JPanel {
    ...
    private ArrayList<viewProperty1.BedroomUI> bedrooms = new ArrayList<>();
    private ArrayList<viewProperty1.Bathroom> bathrooms = new ArrayList<>();
    String hostEmail;
    int numBathrooms;
    int numBedrooms;
    int numBeds;
     ...
     */
    public viewProperty1(Main jFrameInstance, int propertyId) {
        initComponents();
    ...
    public viewProperty1(Main jFrameInstance, int propertyId, String email, Date startDate, Date endDate) {
        initComponents();
        this.jFrameInstance = jFrameInstance;
        this.propertyId = propertyId;
