 ...
 * @author Matyas Szert
 */
public class viewProperty2 extends javax.swing.JPanel {
    ...
    private ArrayList<viewProperty2.BedroomUI> bedrooms = new ArrayList<>();
    private ArrayList<viewProperty2.Bathroom> bathrooms = new ArrayList<>();
    String hostEmail;
    int numBathrooms;
    int numBedrooms;
    int numBeds;
     ...
     */
    public viewProperty2(Main jFrameInstance, int propertyId) {
        initComponents();
