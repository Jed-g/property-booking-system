 ...
 * @author Matyas Szert
 */
public class viewProperty3 extends javax.swing.JPanel {
    ...
    private ArrayList<viewProperty3.BedroomUI> bedrooms = new ArrayList<>();
    private ArrayList<viewProperty3.Bathroom> bathrooms = new ArrayList<>();
    String hostEmail;
    int numBathrooms;
    int numBedrooms;
    int numBeds;
     ...
     */
    public viewProperty3(Main jFrameInstance, int propertyId) {
        initComponents();
